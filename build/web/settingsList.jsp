                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <form action="settingsList" method="get">
                                ...
                                <select name="view" id="viewOption">
                                    ...
                                    <!-- <option value="fuel" ${param.view == 'fuel' ? 'selected' : ''}>Nhiên Liệu</option> -->
                                    <option value="style" ${param.view == 'style' ? 'selected' : ''}>Kiểu Dáng</option>
                                    <option value="segment" ${param.view == 'segment' ? 'selected' : ''}>Phân Khúc</option>
                                    <option value="brand" ${param.view == 'brand' ? 'selected' : ''}>Thương Hiệu</option>
                                    <option value="supply" ${param.view == 'supply' ? 'selected' : ''}>Nhà Cung Cấp</option>
                                </select>
