...
public class EditProductImageServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if ("delete".equals(action)) {
            ...
            productDAO.updateImage(oldImageUrl, newImageUrl); // Gọi phương thức cập nhật hình ảnh
            response.sendRedirect("editproductbymarketing?id=" + id); // Redirect sau khi cập nhật
        }
    }
