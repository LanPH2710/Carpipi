 ...
 * @author hiule
 */
public class MakettingFilter implements Filter {
    ...
    public MakettingFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("MakettingFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("MakettingFilter:DoAfterProcessing");
        }
    ...
    boolean managerPageRequest = requestURI.contains("/maketting") ;
    ...
    if (loggedIn) {
       LoginDAO login = new LoginDAO();
        ...
        if (acc != null) {
            ...
            if (managerPageRequest && acc.getRoleId() != 3) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("MakettingFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("MakettingFilter()");
        }
        StringBuffer sb = new StringBuffer("MakettingFilter(");
