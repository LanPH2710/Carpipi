        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="container1">
                ...
                <div class="blog-content">
                    ...
                    <form action="addblogbymarketing" method="post">

                        <div class="blog-meta"><h2>Tác giả: ${sessionScope.account.firstName} ${sessionScope.account.lastName}</h2></div>
                    <div class="blog-meta">
                        <div class="form-group">
                            <span>
                                <label for="topic">Chủ đề: </label>
                            </span>
                            <select name="topic" style="height:55px; border-radius: 10px; padding: 10px; border: 1px solid #ccc;">
                                <c:forEach items="${requestScope.listTopic}" var="topic">
                                    <option value="${topic.blogTopicId}">${topic.toppicName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <h1>Tiêu đề: </h1>
                    <h1 class="blog-title"><textarea name="title" rows="4" class="form-control" placeholder="Nhập mô tả"></textarea></h1>
...
<!--                    <div class="blog-image-container">
                    ...
                    <div class="blog-section">
                        <h1>Luận điểm 1: </h1>
                        <h5 style="border: 0px;"><textarea name="main1" rows="2" class="form-control" placeholder="Nhập mô tả" required></textarea></h5>
...
<!--                    <div class="blog-image-container">
                    ...
                    <div class="blog-section">
                        <h1>Luận điểm 2: </h1>
                        <h5><textarea name="main2" rows="2" class="form-control" placeholder="Nhập mô tả" required></textarea></h5>
...
<!--                    <div class="blog-image-container">
                    ...
                    <div class="blog-section">
                        <h1>Luận điểm 3: </h1>
                        <h5><textarea name="main3" rows="4" class="form-control" placeholder="Nhập mô tả" required></textarea></h5>
                        <p><textarea name="sp3" rows="6" class="form-control" placeholder="Nhập mô tả" required></textarea></p>
                    </div>

                    <div class="blog-conclusion">
                        <h1>Kết luận: </h1>
                        <h5><textarea name="end" rows="6" class="form-control" placeholder="Nhập mô tả" required></textarea></h5>
                    </div>
                    </br>
