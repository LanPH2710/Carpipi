    ...
    <body>
        <div class="row navHeader container-fluid">
            ...
            <div class="col-8 menu">
                <span class="headerN"><a href="home" style="text-decoration:none; color: white">Trang Chủ</a></span>
                ...
                <span class="headerN"><a href="userprofile" style="text-decoration:none; color: white">Tai Khoan</a></span>
            </div>
