            ...
            <div class="table-responsive">
                <form action="vnpay" id="frmCreateOrder" method="post">        
                    <div class="form-group">
                        <label for="amount" style="font-size: 20px">Số tiền:  <fmt:formatNumber value="${balance}"/> USD</label>
                        <fmt:formatNumber value="${balance}" type="number" groupingUsed="false" maxFractionDigits="0" var="formattedBalance" />
                        <input value="${formattedBalance}" type="hidden" class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" name="amount" />
                    </div>
